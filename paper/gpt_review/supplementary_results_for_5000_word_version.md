...
Across the held-out complete-null assessment, the proportion of replicates producing at least one discovery ranged from 0.01 to 0.18 across the 16 cells, and 13 cells were at or below the nominal 0.10 level. The BRAF-tumor radiation-curated cell had a rate of 0.10 (95% CI, 0.049–0.176), and the BRAF-normal radiation-curated cell had a rate of 0.12 (95% CI, 0.064–0.200). The only cell whose interval lay above 0.10 was BRAF-normal/Hallmark, with a rate of 0.18 (95% CI, 0.110–0.270). Pooled across cells, 102 of 1,600 replicates produced at least one discovery (0.064). Because the 100 pseudo-observations within a cell shared one null pool, their indicators were positively correlated and the ordinary binomial intervals are somewhat narrow.
