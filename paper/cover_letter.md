...
研究者確認事項: (i) 日付、(ii) プレプリントの有無(現状「未掲載」で起草 — 掲載する場合は該当文を差し替え)、(iii) 署名の形、(iv) BJC 既刊への言及段落(Detours 2005/2007・Dom 2012・Abend 2013 — PubMed で誌名・年を照合済み 2026-08-29)と枠組みの適用可能性の段落 — 2026-08-29 に全段落を本文の強度・限定句へ整合(自己評価的修辞を除去)済み。Thyroid への旧投稿は BJC 規定上の開示義務なし(内容も解析も別物のため言及しない)。
