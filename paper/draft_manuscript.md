...
<!-- C-08 --> Of 57,694 candidate pairs, 153 met the selection criteria <!-- N-35 --> and 10 formed the final panel <!-- N-37 --> (Table S3; Supplementary Results). The maximum reversal score among dose-zero construction cases was 2 <!-- N-38 -->. At the resulting cutoff, all 12 dose-zero RET fusion-positive cases scored at or below it and 13 of 15 High-AS RET fusion-positive cases scored above it <!-- N-38 -->. This separation was expected because both extreme bands informed pair selection and the dose-zero cases set the cutoff; it was not treated as an estimate of classification performance.
