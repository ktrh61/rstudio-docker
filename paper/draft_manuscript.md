...
The interpretation map fixed for the four contrasts is given in Table 2; readings for every outcome pattern were assigned before the finalized analysis produced the results reported here.

【訳】4対比について固定した解釈マップを表2に示す。全ての結果パターンへの読みは、確定解析が本稿で報告する結果を生成する前に割り当てられた。
