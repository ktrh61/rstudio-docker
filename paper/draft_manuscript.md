...
Under the separate gene-sampling reference, genes expressed less highly in High-AS RET fusion-positive PTCs were over-represented in proliferation, cell-cycle, and DNA-repair annotations, including E2F targets (46/199), G2M checkpoint (41/198) <!-- N-61 -->, and Reactome DNA repair (68/322) <!-- N-62 -->. Radiation-curated flags reflected the same cell-cycle theme rather than an independent theme <!-- N-60 -->. No set met the over-representation threshold in any family among genes expressed more highly in High-AS RET fusion-positive PTCs (Table S3) <!-- N-59, C-14 -->. These annotations were hypothesis-generating and did not change the null result of the label-permutation gene-set analysis.
