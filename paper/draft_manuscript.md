...
シードは 19860426、診断は基底 19450809 から文書化されたシードを引く <!-- N-05, N-06 -->。全パイプラインは2台の x86-64 マシンで独立に実行され、1,819 の生入力ファイルは md5 一致 <!-- N-52 -->、テストスイートは両機で通過(415 テスト、失敗 0
