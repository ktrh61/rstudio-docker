...
- 語数(2026-08-29): 本文 **4,985**(正本基準 = author-year 引用のまま・見出し除く、余裕 15)/
  投稿版基準(引用 [n] 変換後)4,847(余裕 153 — ジャーナルが見る形)。Abstract 197(余裕 3)。
  基準の選択は研究者判断(従来の台帳数値は正本基準)。機械検査(凍結4・N/C タグ・引用31/警告0・
