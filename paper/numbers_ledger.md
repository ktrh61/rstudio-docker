...
- 語数(2026-08-29 夕): 正本基準(author-year 引用のまま・見出し除く)と投稿版基準([n] 変換後 —
  ジャーナルが見る形)の 2 本立て。最新値は直近の改訂メモ参照。Abstract 197(余裕 3)。
  基準の選択は研究者判断(従来の台帳数値は正本基準)。機械検査(凍結4・N/C タグ・引用 33/警告0・
