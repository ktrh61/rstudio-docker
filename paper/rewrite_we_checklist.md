...
- [ ] "The Brunner–Munzel contrast is the protocol-wide two-sample statistic by design: the analysis takes the order relation as its primitive..." — プロトコル全体の原理コミットメント(最重要の判断文)。例: We take the order relation as the analysis's primitive...
