...
- [ ] "Three candidate confounders of the exposure contrasts are pre-specified from the design and disclosed rather than adjusted for..." — 交絡フェーズの宣言(候補の事前指定+調整でなく開示)。例: We pre-specified three candidate confounders and disclose rather than adjust for them...
